  ...
  return (
    <section className="section mt-16">
      <div className="container">
        <div className="p-6 border border-[#636363] border-solid rounded-3xl m-auto shadow-xl w-full">
            ...
            {loading == 2 && tableLoading == 2 && <>
              ...
              <div className=" px-4 py-3 sm:px-6">
                <div className="flex justify-center items-center">
                  ...
                  <button className="relative inline-flex items-center rounded-md border border-[#636363] bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:cursor-pointer hover:bg-gray-50 mx-2">  {page} / {(parseInt(tokenData.total / 20) + 1)}</button>
                  <input type='button' className={`relative btn btn-primary hover:bg-[#178f6f] inline-flex items-center rounded-md border px-4 py-2 text-sm font-mediumhover:cursor-pointer`} onClick={() => goto(page + 1)} value=">" />
                </div>
              </div>
            </>}
